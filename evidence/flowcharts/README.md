...
Mermaid sources (`.mmd`) and rendered PNGs used in the company report. Regenerate PNGs from `.mmd` if you change the diagrams.

| Folder | Contents |
|---|---|
| `muxi_flowcharts/` | Industry chain, method taxonomy, MimicGen, VLA readiness ladder |
